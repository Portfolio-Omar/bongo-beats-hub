...
const Monetization: React.FC = () => {
  ...
  return (
    <div className="container px-4 py-6 sm:py-8 space-y-4 sm:py-6 sm:py-8 space-y-4 sm:space-y-6">
      ...
      {/* Stats */}
      <div 2 lg:grid-cols-4 gap-3 sm:rid-cols-2 lg:grid-cols-4 gap-4">
